...
Ext.FlashComponent = Ext.extend(Ext.BoxComponent, {
    ...
    onRender : function(){
        ...
        var params = Ext.apply({
            ...
            // Latest YUI charts requires the id be yuiswf1, yuiswf2... yuiswfn
...
// Latest YUI charts requires the YUICallbackBridge be fixed
(function() {
    ...
    if (old) {
        // If we already have YUI included, call that first
