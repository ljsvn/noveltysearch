...
<%
   ...
   String type;
    ...
    %>
     ...
     <%} if( buttonShow){%> 
     <input type="button" onClick='javascript:onClickSearch();' value="搜" style="FONT-WEIGHT: bold;font-family:宋体;font-size: 14px; repeat-x;border: solid 0px #ffffff;color: #007AB5;width:80px;height: 25px;background: url(<%= request.getContextPath() %>/image/search.gif) no-repeat;">
	 <%}%> 
	 <br>
	 <br>
