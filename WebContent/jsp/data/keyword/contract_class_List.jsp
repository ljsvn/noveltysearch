...
<% String local = request.getContextPath(); %>
{
		...
		sm : new Ext.grid.CheckboxSelectionModel({
			...
			,listeners:{
				'rowselect': function(_sm, _index, _record){
				   var filtertree = _sm.grid.findParentByType('panel').findParentByType('panel').findParentByType('panel').findByType('treepanel')[0];
				   filtertree.loader.baseParams['subjectClassPk']=_record.get('subjectClassPk');
				   filtertree.loader.baseParams['contractPk']=_sm.grid.store.baseParams['contractPk'];
			       filtertree.loader.baseParams['nodeFlag']=2;
		...
		,store : new Ext.data.Store( {
			...
			reader : new Ext.data.JsonReader({
                ...
                "createTime","deleteType","contractPk"
			])
		...
		,listeners:{
			...
			new Ext.Window(
			{
				layout: 'border', title: '查看检索主题分类--网页对话框', autoDestroy: true, width: 680, height: 520,
				...
				{
					url : '<%=local %>/confirem/view_page.ods',
					params : {
					contractSubjectPk : records[0].get('contractSubjectPk'),
