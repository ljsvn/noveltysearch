...
<% String local = request.getContextPath(); %>
{
	...
	items : [
	{
			layout: 'table',rowspan: 4, items: [
			{
			...
			
				{
					...
					, value: '${searchDatabase.searchDatabaseName}'
					, fieldLabel: '名称'
					, anchor: '90%'
					, xtype: 'textfield'
					, tabIndex: 1
	...
	,
	{
	  ...
	  , tabIndex: 12
	           ...
	           ,{
					name: 'searchDatabase.searchDatabasePk', value: '${searchDatabase.searchDatabasePk }', xtype: 'hidden'
				}
				,
				{
					name: 'searchDatabase.createOrgPk', value: '${searchDatabase.createOrgPk }', xtype: 'hidden'
				}
				,
				{
					name: 'searchDatabase.createUserPk', value: '${searchDatabase.createUserPk }', xtype: 'hidden'
				}
				,
				{
					name: 'searchDatabase.createTime', value: '${searchDatabase.createTime }', xtype: 'hidden'
				}
				,
				{
					name: 'searchDatabase.deleteType', value: '${searchDatabase.deleteType }', xtype: 'hidden'
				}
