 ...
 *                  {
 *                  fieldLabel: '时间'
 *			    	,name: 'salaryMonthInfo.wageYyyymm'
 *			    	,anchor: '29.8%'
 *			    	,xtype: 'ods.monthfield'
 *			    	,allowBlank: false
 *			    	}
 *  
 *  
...
Ext.ux.MonthField = Ext.extend(Ext.form.TriggerField,{
    ...
    onSelect:function(menu, date){
        ...
        var yearmonths = [];
         yearmonths = tempdate.split('-');
         var year = yearmonths[0].trim();
         var month = yearmonths[1].trim();
         if(month<10){
         	month = '0'+month;
         }
        tempdate = year +'-'+month;
        this.setValue(tempdate.trim());
//        this.setValue(date);
...
Ext.reg('ods.monthfield', Ext.ux.MonthField);
